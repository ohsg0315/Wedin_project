...
public class NewMoviePageAdapter extends RecyclerView.Adapter<NewMoviePageAdapter.FreeMovieViewHolder> {

    Context context;
    private List<MovieObj> list;
    private List<Integer> priceArray;
    private NewMoviePage.OnItemClick listener;
    int i;

    public NewMoviePageAdapter(List<MovieObj> list, Context context, NewMoviePage.OnItemClick listener) {
        this.list = list;
